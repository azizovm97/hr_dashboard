...
with tab6:
    ...
    try:
        ...
        if sheet_name_gallup:
            ...
            # Заменяем все тире, дефисы и пропуски на NaN
            ...
            if quarter_cols:
                ...
                # Принудительная безопасная конвертация в числа ВСЕХ колонок кроме квартала (errors='coerce')
                # Плюс защита от запятых в десятичных дробях
